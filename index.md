...
```json
{
  ...
  "id" : "smart.who.int.big",
  "url" : "http://smart.who.int/big/ImplementationGuide/smart.who.int.big",
  "version" : "0.1.0",
  "name" : "largeIG",
  "status" : "draft",
  "date" : "2026-04-25T08:04:35+00:00",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://smart.who.int/big/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "CodeSystem/bulk-test-cs-clinical"
      },
      "name" : "Bulk Test CodeSystem � Clinical Observations",
    ...
    },
    {
      ...
      "exampleCanonical" : "http://smart.who.int/big/StructureDefinition/MyPatient"
    }],
    "page" : {
      "extension" : [{
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "business-process.html"
        }],
        "nameUrl" : "business-process.html",
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "index-dak.html"
        }],
        "nameUrl" : "index-dak.html",
        "title" : "Index Dak",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "index-ig.html"
        }],
        "nameUrl" : "index-ig.html",
        "title" : "Index Ig",
        "generation" : "markdown"
      },
      {
      ...
      },
      {
        ...
        "title" : "Trust Domain Specifications",
        "generation" : "markdown"
      },
      {
        "extension" : [{
